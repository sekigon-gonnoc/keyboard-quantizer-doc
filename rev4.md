...
||説明|
|-|-|
|[初期ファームウェア]()| 初期状態のファームウェアです。接続したUSB危機のディスクリプタを解析して認識しようとしますが、うまくいかない場合もあります。マウスを認識することもできます|
|[固定パーサファームウェア]()|6KROのキーボードと決め打ちして入力を認識します。初期ファームウェアではうまく認識できないキーボードが認識できる場合があります。マウスは認識できません|
